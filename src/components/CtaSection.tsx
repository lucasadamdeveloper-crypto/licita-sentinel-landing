      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative rounded-2xl p-8 sm:p-14 bg-slate-900 border border-slate-800 shadow-2xl text-center overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto space-y-6 relative z-10">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-950/70 border border-emerald-500/30 text-xs font-semibold text-emerald-300">
